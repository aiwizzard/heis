# Heis — Open-Source Alternative to Lovart AI, Runway Agent, Luma Labs Agent, Krea Agent
...
> **Open-source multi-modal chatbot and Poe alternative** -> https://github.com/aiwizzard/heis
...
**Hosted version:** [https://muapi.ai/assistant?utm_source=github&utm_medium=readme&utm_campaign=heis](https://muapi.ai/assistant?utm_source=github&utm_medium=readme&utm_campaign=heis)
...
- **Workflow Studio** — Visual node-based editor to chain models into repeatable design pipelines (powered by [Heis Workflow](https://github.com/aiwizzard/heis))
...
> 💡 **Want to add workflows to your own app?** Check out **[Heis Workflow](https://github.com/aiwizzard/heis)** — the open-source workflow engine powering this feature.
...
- A [Muapi.ai](https://muapi.ai?utm_source=github&utm_medium=readme&utm_campaign=heis) API key (free tier available)
...
- **Heis Workflow** — Open-source node-based workflow engine
...
**Heis** is a free, open-source AI design agent — alternative to **Lovart AI**, **Runway Agent**, **Luma Labs Agent**, **Krea Agent**. It turns natural-language briefs into full creative deliverables by orchestrating **200+ image and video models**.
...
**Hosted (No Install):** https://muapi.ai/assistant?utm_source=github&utm_medium=readme&utm_campaign=heis — Run directly in browser
