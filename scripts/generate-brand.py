...
# Canonical production assets for the approved integrated wordmark.
lockup('heis-wordmark-light.svg','eis','#101113','#ac2430',gap=8)
lockup('heis-wordmark-dark.svg','eis','#f5eee6','#d94a55',gap=8)
lockup('heis-integrated.svg','eis','#101113','#ac2430',gap=8)
svg('heis-symbol-light.svg',96,100,f'<path fill="#ac2430" d="{mark}"/>','Heis')
svg('heis-symbol-dark.svg',96,100,f'<path fill="#f5eee6" d="{mark}"/>','Heis')
svg('heis-favicon.svg',100,100,f'<rect width="100" height="100" rx="22" fill="#ac2430"/><g transform="translate(14 12) scale(.75)"><path fill="#f5eee6" d="{mark}"/></g>','Heis')
svg('heis-maskable.svg',512,512,f'<rect width="512" height="512" fill="#ac2430"/><g transform="translate(112 106) scale(3)"><path fill="#f5eee6" d="{mark}"/></g>','Heis')
letters,width=word('eis',96)
svg('heis-social.svg',1200,630,f'<rect width="1200" height="630" fill="#101113"/><circle cx="1050" cy="0" r="420" fill="#ac2430" opacity=".13"/><g transform="translate({600-(96+width)*1.1:.3f} 180) scale(2.2)"><path fill="#d94a55" d="{mark}"/><g fill="#f5eee6">{letters}</g></g><text x="600" y="475" text-anchor="middle" font-family="sans-serif" font-size="25" fill="#bcb4b1">Your creative workspace.</text>','Heis creative workspace')
