...
export default function CodexStudio({ sidebarTarget }: { sidebarTarget?: HTMLElement | null }) {
 ...
 <div className="heis-agent-root flex-1"><App sidebarTarget={sidebarTarget} /></div></div>;
}
