...
export default function CodexStudio({ sidebarTarget, projectDirectory, design, compact = false }: { sidebarTarget?: HTMLElement | null; projectDirectory?: string; design?: {projectId:string;sessionId:string}; compact?: boolean }) {
 ...
 <div className="heis-agent-root flex-1"><App sidebarTarget={sidebarTarget} projectDirectory={projectDirectory} design={design} compact={compact} /></div></div>;
}
