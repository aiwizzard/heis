...
export default function CodexStudio({ sidebarTarget, projectDirectory, compact = false }: { sidebarTarget?: HTMLElement | null; projectDirectory?: string; compact?: boolean }) {
 ...
 <div className="heis-agent-root flex-1"><App sidebarTarget={sidebarTarget} projectDirectory={projectDirectory} compact={compact} /></div></div>;
}
