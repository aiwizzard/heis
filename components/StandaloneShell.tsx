...
const LayersStudio = (props: any) => <Suspense fallback={<div className="p-8 text-white/50">Loading studio...</div>}><LazyLayersStudio {...props} /></Suspense>;
const LazyImageStudio = lazy(() => import('../packages/studio/src/components/ImageStudio'));
const ImageStudio = (props: any) => <Suspense fallback={<div className="p-8 text-white/50">Loading studio...</div>}><LazyImageStudio {...props} /></Suspense>;
const LazyVideoStudio = lazy(() => import('../packages/studio/src/components/VideoStudio'));
const VideoStudio = (props: any) => <Suspense fallback={<div className="p-8 text-white/50">Loading studio...</div>}><LazyVideoStudio {...props} /></Suspense>;
const LazyLipSyncStudio = lazy(() => import('../packages/studio/src/components/LipSyncStudio'));
const LipSyncStudio = (props: any) => <Suspense fallback={<div className="p-8 text-white/50">Loading studio...</div>}><LazyLipSyncStudio {...props} /></Suspense>;
const LazyCinemaStudio = lazy(() => import('../packages/studio/src/components/CinemaStudio'));
const CinemaStudio = (props: any) => <Suspense fallback={<div className="p-8 text-white/50">Loading studio...</div>}><LazyCinemaStudio {...props} /></Suspense>;
const LazyAudioStudio = lazy(() => import('../packages/studio/src/components/AudioStudio'));
const AudioStudio = (props: any) => <Suspense fallback={<div className="p-8 text-white/50">Loading studio...</div>}><LazyAudioStudio {...props} /></Suspense>;
const LazyMarketingStudio = lazy(() => import('../packages/studio/src/components/MarketingStudio'));
const MarketingStudio = (props: any) => <Suspense fallback={<div className="p-8 text-white/50">Loading studio...</div>}><LazyMarketingStudio {...props} /></Suspense>;
const LazyMotionControlStudio = lazy(() => import('../packages/studio/src/components/MotionControlStudio'));
const MotionControlStudio = (props: any) => <Suspense fallback={<div className="p-8 text-white/50">Loading studio...</div>}><LazyMotionControlStudio {...props} /></Suspense>;
const LazyVibeMotionStudio = lazy(() => import('../packages/studio/src/components/VibeMotionStudio'));
const VibeMotionStudio = (props: any) => <Suspense fallback={<div className="p-8 text-white/50">Loading studio...</div>}><LazyVibeMotionStudio {...props} /></Suspense>;
const LazyRecastStudio = lazy(() => import('../packages/studio/src/components/RecastStudio'));
const RecastStudio = (props: any) => <Suspense fallback={<div className="p-8 text-white/50">Loading studio...</div>}><LazyRecastStudio {...props} /></Suspense>;
const LazyAiInfluencerStudio = lazy(() => import('../packages/studio/src/components/AiInfluencerStudio'));
...
const COMMERCIAL_READY_TABS = new Set(['clipping', 'layers', 'image', 'video', 'lipsync', 'cinema', 'audio', 'marketing', 'motion-control', 'vibe-motion', 'body-swap', 'agents', 'ai-influencer']);
    ...
    >
      ...
      <div className="flex-1 min-h-0 flex relative overflow-hidden">
        ...
        <div className={activeTab === 'vibe-motion' ? "h-full w-full" : "hidden"}>
          {activeTab === 'vibe-motion' && <VibeMotionStudio apiKey={apiKey} locale={locale} onGenerationStart={makeGenerationStartCallback('vibe-motion')} onGenerationEnd={makeGenerationEndCallback('vibe-motion')} onGenerationComplete={makeSuccessCallback('vibe-motion')} onGenerationError={makeErrorCallback('vibe-motion')} />}
        </div>
